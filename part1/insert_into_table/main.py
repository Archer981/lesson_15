...
cur = con.cursor()
query = """
        insert into animals (AnimalType, `Name`, Sex, DateOfBirth, Age, Weight)
        values ('Кошка', 'Соня', 'Ж', '2013-12-02', 7, 2.15),
        ('Кот', 'Семен', 'М', '2017-05-03', 4, 4.5),
        ('Собака', 'Алина', 'Ж', '2018-11-12', 2, 20.8),
        ('Пес', 'Бобик', 'М', '2015-08-25', 6, 5.75)
"""
sqlite_query = query  # TODO составьте запрос на добавление данных в таблицу
